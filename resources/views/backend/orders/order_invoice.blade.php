  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Laravel Ecommece</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Ecommece Head Office
               Email:companymail@gmail.com<br>
               Mob: 1245454545 <br>
               1/2 Nur Jahan Road, Mohammad Pur, Dhaka <br>
