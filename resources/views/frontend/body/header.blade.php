                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart"
                            ...
                            <div class="items-cart-inner">
                                ...
                                <div class="basket-item-count"><span class="count" id="cart_count">0</span></div>
                                <div class="total-price-basket"> <span class="lbl"></span> <span
                                        class="total-price"> <span class="sign">Tk.</span><span
                                            class="value" id="cart_total">0</span> </span> </div>
                            </div>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
